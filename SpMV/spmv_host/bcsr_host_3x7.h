...
void spmv_bcsr_serial_host_3x7(const bcsr_matrix<IndexType, ValueType>& bcsr, 
                          const ValueType * x,  
                          ValueType * y)
{
...
//  {
    for (I=0; I<num_block_rows; I++, yp += 3)
    {
      register ValueType _y0 = 0, _y1 = 0, _y2 = 0;
      for (K=bcsr.bAp[I]; K<bcsr.bAp[I+1]; K++, bAj_tmp ++, bAx_tmp += 3*7 )
      {
        j0 = bAj_tmp[0];
