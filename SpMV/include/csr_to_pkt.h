           ...
           int packing_heuristic = 2)
{
    ...
    p_mtx.packets.pos_start    = new_array<IndexType>(threads_per_packet * p_mtx.num_packets);
    p_mtx.packets.pos_end      = new_array<IndexType>(threads_per_packet * p_mtx.num_packets);
    p_mtx.packets.index_array  = new_array<PackedIndexType>(threads_per_packet * total_local_work);
    p_mtx.packets.data_array   = new_array<ValueType>(threads_per_packet * total_local_work);
    ...
    p_mtx.coo.I = new_array<IndexType>(global_nonzeros); 
    p_mtx.coo.J = new_array<IndexType>(global_nonzeros); 
    p_mtx.coo.V = new_array<ValueType>(global_nonzeros); 
